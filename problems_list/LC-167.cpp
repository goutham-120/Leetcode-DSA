    ...
    vector<int> twoSum(vector<int>& numbers, int target) {
        ...
        while (l < r) {
            ...
            if (sum == target) {
                ...
                // Problem uses 1-based indexing, so return l+1 and r+1.
                return {l + 1, r + 1};
            }
            else if (sum < target) {

                // Sum is too small.
                // Since the array is sorted, move l right
                // to get a larger value and increase the sum.
                l++;
            }
            else {

                // Sum is too large.
                // Move r left to get a smaller value
                // and decrease the sum.
                r--;
            }
        }
